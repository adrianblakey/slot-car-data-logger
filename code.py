        ...
        <script type="text/javascript">
            ...
            function init() {
                ...
                var materialOptions = {
                    ...
                    series: {
                        0: {color: 'red', lineWidth: 1, targetAxisIndex: 0},
                        1: {color: 'blue', lineWidth: 1, targetAxisIndex: 1},
                        2: {color: 'orange', lineWidth: 1, targetAxisIndex: 1}
                    },
                    vAxes: {
                        0: {
                            title:'Current (A)',
                ...
                function onMessage(event) {
                    ...
                    if (eTime > materialOptions.hAxis.viewWindow.max) {          // Slide the window right every 10 sec
                        console.log('eTime is bigger than max, move vw', eTime, materialOptions.hAxis.viewWindow.max);
                        materialOptions.hAxis.viewWindow.min = materialOptions.hAxis.viewWindow.min + 10;
                        materialOptions.hAxis.viewWindow.max = materialOptions.hAxis.viewWindow.max + 10;
                        data.removeRows(0, rowCount - 1);                        // garbage collect
                    }
